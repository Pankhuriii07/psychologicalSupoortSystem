...
const socket = io.connect("https://psychologicalsupoortsystem-3.onrender.com");
...
const StudentChat = () => {
    ...
    const loadHistory = async () => {
        const res = await axios.get(`https://psychologicalsupoortsystem-3.onrender.com/api/chat/${studentId}`);
    ...
    const sendMessage = async () => {
        ...
        try {
            const res = await axios.post('https://psychologicalsupoortsystem-3.onrender.com/api/chat', {
                studentId: studentId,
