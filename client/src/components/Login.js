...
const Login = () => {
    ...
    try {
        const res = await axios.post('https://psychologicalsupoortsystem-3.onrender.com/api/auth/login', { email, password });
    ...
    try {
        const res = await axios.post(
            'https://psychologicalsupoortsystem-3.onrender.com/api/auth/login',
            formData
        );
